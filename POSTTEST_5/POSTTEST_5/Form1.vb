Public Class Form1
    ...
    End Function
    Private Sub TampilData(dgvData As DataGridView, value As Object)
        Throw New NotImplementedException()
    End Sub
    ...
    Private Sub SimpanData(text1 As String, text2 As String, text3 As String, text4 As String, v As Object)
        Throw New NotImplementedException()
    End Sub

    Private Function IsUIDDuplicate(text As String) As Boolean
        Throw New NotImplementedException()
    End Function
    ...
    Private Sub CariData(dgvData As DataGridView, text As String, v As Object)
        Throw New NotImplementedException()
    End Sub
